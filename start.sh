...
# MindCare AI System Startup Script (Backend & AI Only - Vercel handles Frontend)
echo "🚀 Starting MindCare AI System..."
...
# Using PM2 to manage Python keeps logs clean and unified with Node
pm2 start app.py --name "ai-service" --interpreter python3
...
# ============================================
# 3. Save PM2 Process List & Show Status
# ============================================
pm2 save
...
echo ""
echo "📊 Service Endpoints:"
echo "   - Backend (Node): http://localhost:5000/api"
echo "   - AI Service (Flask): http://localhost:5001/predict"
echo "   - Frontend: Hosted on Vercel ✅"
echo "=========================================="

# Keep container alive by streaming PM2 logs
pm2 logs
